...
public class SimulinkModel extends AbstractSimulinkModel implements IOperationContributorProvider {
	...
	public void simulate() throws InterruptedException {
		...
		try {
			engine.evalAsync("simout = sim('" + name + "', 'SimulationMode','normal','StopTime','10', 'SaveState','on','StateSaveName','xout', 'SaveOutput','on', 'OutputSaveName','yout', 'SaveFormat', 'Dataset');").get();
